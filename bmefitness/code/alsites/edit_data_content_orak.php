		...
		print "<div id=\"rightcontent\">";
			...
			print "<p>";
				print "<table>";
					...
					print "<tr><td><b>Fotó:</b></td><td>".($object->foto == "" ? "" : "<img src=\"data/data_orak/".$object->foto.".jpg\">")."</td></tr>";
					print "<tr><td><b>Logó:</b></td><td>".($object->logo == "" ? "" : "<img src=\"data/data_orak/".$object->logo.".jpg\">")."</td></tr>";
				print "</table>";
			print "</p>";
			print "<div onclick='begin_new_or_edit_data(\"".$tablename."\", ".$ojson.");' class=\"action_button\">Szerkesztés</div>";
		print "</div>";
