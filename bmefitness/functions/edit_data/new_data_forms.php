<?php
	if (isset($_POST["type"])) {
		...
		if ($edit == "info") { // pontosabban egy uj edzo letrehozasa
			...
			print "
				<table class=\"edit_data_table\">
					<tr><td id=\"edit_ora_name\" class=\"td_right ".(is_null($object) || strlen($object->nev) == 0 ? "redcolor" : "")."\">Név:</td><td class=\"td_left\"><input maxlength=\"30\" size=\"31\" type=\"text\" id=\"oraname\" ".(is_null($object) ? "" : "value=\"".$object->nev."\" ")."onchange=\"editedField('edit_ora_name', 'oraname', false, 25);\"></input></td></tr>\n
					...
					<tr><td id=\"edit_ora_perc\" class=\"td_right ".(is_null($object) || strlen($object->perc) == 0 ? "redcolor" : "")."\">Perc:</td><td class=\"td_left\"><input maxlength=\"30\" size=\"31\" type=\"text\" id=\"oraperc\" ".(is_null($object) ? "" : "value=\"".$object->perc."\" ")."onchange=\"editedField('edit_ora_perc', 'oraperc', false, 0);\"></input></td></tr>\n
					<tr><td id=\"edit_ora_maxletszam\" class=\"td_right ".(is_null($object) || strlen($object->max_letszam) == 0 ? "redcolor" : "")."\">Max létszám:</td><td class=\"td_left\"><input maxlength=\"30\" size=\"31\" type=\"text\" id=\"oramaxletszam\" ".(is_null($object) ? "" : "value=\"".$object->max_letszam."\" ")."onchange=\"editedField('edit_ora_maxletszam', 'oramaxletszam', false, 0);\"></input></td></tr>\n
